var reactTableVisuals34949B876CBF44E8B20124F33F741B4E_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
class DataPointCardSettings extends (/* unused pure expression or super */ null && (FormattingSettingsCard)) {
    constructor() {
        super(...arguments);
        this.defaultColor = new formattingSettings.ColorPicker({
            name: "defaultColor",
            displayName: "Default color",
            value: { value: "" },
        });
        this.showAllDataPoints = new formattingSettings.ToggleSwitch({
        ...
        this.fillRule = new formattingSettings.ColorPicker({
            name: "fillRule",
...
class VisualFormattingSettingsModel extends FormattingSettingsModel {
    constructor() {
        ...
        this.demoSec = new DemoSection();
        this.cards = [this.demoSec];
    }
}
class DemoSection extends FormattingSettingsCard {
    constructor() {
        super(...arguments);
        this.title = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .TextInput */ .oi({
            name: "title",
            displayName: "Title",
            value: "",
            placeholder: "Enter title",
        });
        this.subTitle = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .TextInput */ .oi({
            name: "subTitle",
            displayName: "Sub Title",
            value: "",
            placeholder: "Enter sub title",
        });
        this.name = "demoSection";
        this.displayName = "Demo Section";
        this.slices = [this.title, this.subTitle];
    }
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   h: () => (/* binding */ TableVisual)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(294);


class TableVisual extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        super(props);
        this.state = {
            tableHead: [],
    ...
    renderTable() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "div-container" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, title),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, subTitle),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("table", null,
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("thead", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", null,
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", null, "IIndex"),
                        tableHead.map((header, index) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", { key: index }, header))))),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("tbody", null, tableData.map((row, rowIndex) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", { key: rowIndex },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", null, rowIndex + 1),
                    row.map((cell, cellIndex) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", { key: cellIndex }, cell !== null && cell !== undefined ? cell : ""))))))))));
    }
    render() {
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, this.renderTable());
    }
}
...
/* harmony import */ var _table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(964);
...
class Visual {
    constructor(options) {
        ...
        this.tableVisual = new _table__WEBPACK_IMPORTED_MODULE_1__/* .TableVisual */ .h({ dataView: null });
    ...
    update(options) {
        ...
        this.formattingSettings =
            this.formattingSettingsService.populateFormattingSettingsModel(_settings__WEBPACK_IMPORTED_MODULE_0__/* .VisualFormattingSettingsModel */ .E, options.dataViews[0]);
        if (options.dataViews && options.dataViews[0]) {
            try {
                this.tableVisual.updateTableData(options.dataViews[0]);
                react_dom__WEBPACK_IMPORTED_MODULE_2__.render(this.tableVisual.render(), this.target);
            }
            catch (error) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (reactTableVisuals34949B876CBF44E8B20124F33F741B4E_DEBUG);

})();

reactTableVisuals34949B876CBF44E8B20124F33F741B4E_DEBUG = __webpack_exports__;
/******/ })()
;
